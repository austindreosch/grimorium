const en = {
  ...
  lines: [
    ...
    { type: 'INFO', text: 'If the nominator is not a Townsfolk, nothing happens and the nomination continues.' },
    { type: 'CAVEAT', text: 'This ability is spent after the first nomination, regardless of the result.' },
