const es = {
  ...
  lines: [
    ...
    { type: 'INFO', text: 'Si el nominador no es un Aldeano, nada sucede y la nominación continúa.' },
    { type: 'CAVEAT', text: 'Esta habilidad se gasta tras la primera nominación, sin importar el resultado.' },
