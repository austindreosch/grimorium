...
const en: Translations = {
  ...
  game: {
    ...
    board: {
      ...
      editName: 'Name player',
      namePlayer: 'Name player',
      moveClockwise: 'Move seat clockwise',
      moveCounter: 'Move seat counter-clockwise',
    ...
    panels: {
      ...
      dusk: 'Dusk',
      dawn: 'Dawn',
      duskHint: 'Start the Night Phase.',
      dawnHint: 'Wait a few seconds, then end the Night Phase.',
      minionInfo: 'Minion Info',
      demonInfo: 'Demon Info',
      minionInfoHint: 'Wake all Minions — show them each other and the Demon.',
      demonInfoHint: 'Wake the Demon — show the Minions, then give 3 not-in-play bluffs.',
    },
    infoTokens: {
      showCard: 'Show Card',
      title: 'Info Token',
      ...
      presets: {
        ...
        oneOfThese: { label: 'One Of These', message: 'ONE OF THESE PLAYERS IS' },
        characterInPlay: { label: 'In Play', message: 'THIS CHARACTER IS IN PLAY' },
        selectedYou: { label: 'Selected You', message: 'THIS PLAYER SELECTED YOU' },
        thisPlayerIs: { label: 'This Player Is', message: 'THIS PLAYER IS' },
        yourGrandchild: { label: 'Your Grandchild Is', message: 'YOUR GRANDCHILD IS' },
      },
    },
  },
  ...
  teams: {
    ...
    traveller: {
      name: 'Traveller',
      winCondition: 'Wins with their assigned alignment.',
    },
    fabled: {
      name: 'Fabled',
      winCondition: 'A special character that helps the game run.',
    },
  },
  ...
  history: {
    ...
    playerAdded: 'Storyteller added {name}',
    playerRemoved: 'Storyteller removed {name}',
    playerRenamed: 'Storyteller renamed a seat to {name}',
    playerMoved: 'Storyteller moved {name} around the table',
  ...
  scripts: {
    ...
    importPlaceholder: 'Paste script-tool JSON here, or drop a .json file…',
    importChooseFile: 'Upload .json',
    importLoad: 'Load',
