...
const es: Translations = {
  ...
  newGame: {
    ...
    savedPeople: 'Personas guardadas',
  ...
  game: {
    ...
    board: {
      ...
      editRoster: 'Editar jugadores',
      editName: 'Nombrar jugador',
      namePlayer: 'Nombrar jugador',
      moveClockwise: 'Mover asiento en sentido horario',
      moveCounter: 'Mover asiento en sentido antihorario',
      resetView: 'Restablecer zoom',
      namePlaceholder: 'Nombre del jugador',
      savedNames: 'Nombres guardados',
      save: 'Guardar',
    },
    panels: {
      menu: 'Menú',
      ...
      dusk: 'Anochecer',
      dawn: 'Amanecer',
      duskHint: 'Comienza la fase nocturna.',
      dawnHint: 'Espera unos segundos y termina la fase nocturna.',
      minionInfo: 'Info de Secuaces',
      demonInfo: 'Info del Demonio',
      minionInfoHint: 'Despierta a los Secuaces: muéstrales quiénes son y quién es el Demonio.',
      demonInfoHint: 'Despierta al Demonio: muéstrale a los Secuaces y dale 3 personajes fuera de juego.',
    },
    infoTokens: {
      ...
      deck: {
        ...
        lleechKill: 'ELIGE UN JUGADOR PARA MATAR',
        assassinKill: 'ELIGE UN JUGADOR PARA MATAR',
        sageDemon: 'EL DEMONIO ES UNO DE ESTOS DOS JUGADORES',
      ...
      presets: {
        ...
        oneOfThese: { label: 'Uno de estos', message: 'UNO DE ESTOS JUGADORES ES' },
        characterInPlay: { label: 'En juego', message: 'ESTE PERSONAJE ESTÁ EN JUEGO' },
        selectedYou: { label: 'Te seleccionó', message: 'ESTE JUGADOR TE SELECCIONÓ' },
        thisPlayerIs: { label: 'Este jugador es', message: 'ESTE JUGADOR ES' },
        yourGrandchild: { label: 'Tu nieto es', message: 'TU NIETO ES' },
      },
    },
  },
  ...
  teams: {
    ...
    traveller: {
      name: 'Viajero',
      winCondition: 'Gana con la alineación que se le asigne.',
    },
    fabled: {
      name: 'Fabuloso',
      winCondition: 'Un personaje especial que ayuda a que la partida funcione.',
    },
  },
  ...
  history: {
    ...
    playerAdded: 'El Cuentacuentos añadió a {name}',
    playerRemoved: 'El Cuentacuentos eliminó a {name}',
    playerRenamed: 'El Cuentacuentos renombró un asiento a {name}',
    playerMoved: 'El Cuentacuentos movió a {name} alrededor de la mesa',
  ...
  scripts: {
    ...
    'everyone-can-play': 'Everyone Can Play',
    ...
    importPlaceholder: 'Pega aquí el JSON del creador de guiones, o suelta un archivo .json…',
    importChooseFile: 'Subir .json',
    importLoad: 'Cargar',
